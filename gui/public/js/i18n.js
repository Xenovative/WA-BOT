...
class I18n {
    ...
    loadTranslations() {
        ...
        this.translations.en = {
            ...
            'chat.import_whatsapp': 'Import WhatsApp History',
            'chat.import_whatsapp_title': 'Import WhatsApp Chat History',
            ...
            'chat.preparing_import': 'Preparing import...',
            'chat.start_import': 'Start Import',
            'chat.import_success': 'Chat history imported successfully',
            'chat.import_failed': 'Failed to import chat history',
            'chat.import_cancelled': 'Import cancelled',
            'chat.fetching_chats': 'Fetching available chats...',
            'chat.importing_messages': 'Importing messages...',
            'chat.import_complete': 'Import completed',
            ...
            'platforms.session_extractor_help': 'How to Extract Session ID',
            'platforms.instagram_private_info': 'Session ID method is more stable and avoids login challenges.',
            'platforms.instagram_session_only': 'Session ID is the only supported authentication method for stability and security.',
        ...
        this.translations['zh-TW'] = {
            ...
            'chat.import_whatsapp': '匯入 WhatsApp 歷史',
            'chat.import_whatsapp_title': '匯入 WhatsApp 聊天記錄',
            'chat.import_info': '從您的 WhatsApp 聊天中匯入特定日期範圍內的訊息。這將直接從 WhatsApp 獲取訊息並保存到您的聊天記錄中。',
            'chat.start_date': '開始日期',
            'chat.end_date': '結束日期',
            'chat.select_chat': '選擇聊天',
            'chat.loading_chats': '載入可用聊天中...',
            'chat.select_chat_help': '選擇要匯入訊息的 WhatsApp 聊天',
            'chat.include_media': '包含媒體訊息',
            'chat.include_system': '包含系統訊息（加入、離開等）',
            'chat.import_progress': '匯入進度',
            'chat.preparing_import': '準備匯入中...',
            'chat.start_import': '開始匯入',
            'chat.import_success': '聊天記錄匯入成功',
            'chat.import_failed': '匯入聊天記錄失敗',
            'chat.import_cancelled': '匯入已取消',
            'chat.fetching_chats': '獲取可用聊天中...',
            'chat.importing_messages': '匯入訊息中...',
            'chat.import_complete': '匯入完成',
            ...
            'platforms.session_extractor_help': '如何提取工作階段 ID',
            'platforms.instagram_private_info': '工作階段 ID 方法更穩定，避免登入挑戰。',
            'platforms.instagram_session_only': '工作階段 ID 是唯一支援的驗證方法，確保穩定性和安全性。',
        ...
        this.translations['zh-CN'] = {
            ...
            'chat.import_whatsapp': '导入 WhatsApp 历史',
            'chat.import_whatsapp_title': '导入 WhatsApp 聊天记录',
            'chat.import_info': '从您的 WhatsApp 聊天中导入特定日期范围内的消息。这将直接从 WhatsApp 获取消息并保存到您的聊天记录中。',
            'chat.start_date': '开始日期',
            'chat.end_date': '结束日期',
            'chat.select_chat': '选择聊天',
            'chat.loading_chats': '加载可用聊天中...',
            'chat.select_chat_help': '选择要导入消息的 WhatsApp 聊天',
            'chat.include_media': '包含媒体消息',
            'chat.include_system': '包含系统消息（加入、离开等）',
            'chat.import_progress': '导入进度',
            'chat.preparing_import': '准备导入中...',
            'chat.start_import': '开始导入',
            'chat.import_success': '聊天记录导入成功',
            'chat.import_failed': '导入聊天记录失败',
            'chat.import_cancelled': '导入已取消',
            'chat.fetching_chats': '获取可用聊天中...',
            'chat.importing_messages': '导入消息中...',
            'chat.import_complete': '导入完成',
            ...
            'platforms.session_extractor_help': '如何提取会话 ID',
            'platforms.instagram_private_info': '会话 ID 方法更稳定，避免登录挑战。',
            'platforms.instagram_session_only': '会话 ID 是唯一支持的认证方法，确保稳定性和安全性。',
